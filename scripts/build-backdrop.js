#!/usr/bin/env node
/**
 * Builds the two backdrop assets the Halloween hub serves, from the full-size
 * original.
 *
...
const OUT = path.join(__dirname, '..', 'public', 'images', 'halloween');
const QUALITY = 0.70;
const VARIANTS = [
  /* name, source crop as fractions {x,y,w,h}, output width */
  { name: 'haunted-house',      crop: { x: 0, y: 0.015, w: 1, h: 0.63 }, width: 1400 },
  { name: 'haunted-house-tall', crop: { x: 0, y: 0,     w: 1, h: 1    }, width: 780 },
];
