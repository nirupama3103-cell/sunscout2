...
const HARDCODED_INDOOR = [
  ...
  // ── SARATOGA ──
  { id:"hi-fr-1", city:"Fremont", source:"google", name:"Fremont Indoor Aquatic Center", desc:"Indoor swimming pool with lessons and open swim for all ages", address:"3590 Stevenson Blvd, Fremont, CA 94538", phone:"(510) 494-4300", website:null, image:"/splash.jpg", isFree:false, price:"From $5", stars:4, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["♿ Wheelchair"], mapsUrl:"https://www.google.com/maps/search/Fremont+Aquatic+Center" },
  { id:"hi-fr-2", city:"Fremont", source:"google", name:"Essanay Silent Film Museum Fremont", desc:"Historic silent film museum in Niles with screenings and exhibits", address:"37417 Niles Blvd, Fremont, CA 94536", phone:"(510) 494-1411", website:"https://www.nilesfilmmuseum.org", image:"/museum.jpg", isFree:false, price:"From $5", stars:4, startDate:"2026-06-01", endDate:"2026-08-31", ages:["1","2","3"], a11y:["♿ Wheelchair"], mapsUrl:"https://www.google.com/maps/search/Essanay+Film+Museum+Fremont" },
  { id:"hi-fr-3", city:"Fremont", source:"google", name:"Altitude Trampoline Park Fremont", desc:"Indoor trampoline park with foam pits dodgeball and climbing walls", address:"Fremont, CA 94538", phone:null, website:"https://www.altitudetrampoline.com", image:"/outcamp.jpg", isFree:false, price:"From $15", stars:4, startDate:"2026-06-01", endDate:"2026-08-31", ages:["1","2","3"], a11y:[], mapsUrl:"https://www.google.com/maps/search/Altitude+Trampoline+Fremont" },
...
const HARDCODED_OUTDOOR = [
  ...
  // ── SARATOGA ──
  { id:"ho-fr-1", city:"Fremont", source:"google", name:"Mission Peak Regional Preserve Fremont", desc:"Iconic Bay Area hike with stunning views. Best for older kids and teens", address:"Stanford Ave, Fremont, CA 94539", phone:null, website:null, image:"/trail.jpg", isFree:true, price:"$0 FREE", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["2","3"], a11y:[], mapsUrl:"https://www.google.com/maps/search/Mission+Peak+Fremont" },
  { id:"ho-fr-2", city:"Fremont", source:"google", name:"Coyote Hills Regional Park Fremont", desc:"Beautiful wetlands with trails wildlife watching and family picnic areas", address:"8000 Patterson Ranch Rd, Fremont, CA 94555", phone:"(510) 544-3220", website:null, image:"/trail.jpg", isFree:false, price:"$5 parking", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Coyote+Hills+Park+Fremont" },
  { id:"ho-fr-3", city:"Fremont", source:"google", name:"Ardenwood Historic Farm Fremont", desc:"Working historic farm with horses carriages and farm animals for families", address:"34600 Ardenwood Blvd, Fremont, CA 94555", phone:"(510) 544-2797", website:null, image:"/horse.jpg", isFree:false, price:"From $8", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Ardenwood+Historic+Farm+Fremont" },
...
const HARDCODED_FREE = [
  ...
  // ── PAID EXTRA - SAN JOSE ──
  { id:"hf-sj-f1", city:"San Jose", source:"google", name:"Guadalupe River Park San Jose", desc:"Free riverside park with trails and playgrounds for families", address:"438 Coleman Ave, San Jose, CA 95110", phone:null, website:null, image:"/park.jpg", isFree:true, price:"$0 FREE", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["♿ Wheelchair","🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Guadalupe+River+Park+San+Jose" },
  { id:"hf-sj-f2", city:"San Jose", source:"google", name:"San Jose Public Library Summer Reading", desc:"Free summer reading program for kids at all San Jose library branches", address:"150 E San Fernando St, San Jose, CA 95112", phone:"(408) 808-2000", website:"https://www.sjpl.org", image:"/library.jpg", isFree:true, price:"$0 FREE", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["♿ Wheelchair","🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/San+Jose+Public+Library" },
  { id:"hf-sj-f3", city:"San Jose", source:"google", name:"Kelley Park San Jose", desc:"Free family park with Japanese Friendship Garden and picnic areas", address:"1300 Senter Rd, San Jose, CA 95112", phone:"(408) 794-7275", website:null, image:"/park.jpg", isFree:true, price:"$0 FREE", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["♿ Wheelchair","🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Kelley+Park+San+Jose" },
  { id:"hf-sj-f4", city:"San Jose", source:"google", name:"Almaden Lake Park Splash Pad", desc:"Free splash pad and lake park for families in South San Jose", address:"6099 Winfield Blvd, San Jose, CA 95120", phone:null, website:null, image:"/park.jpg", isFree:true, price:"$0 FREE", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2"], a11y:["🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Almaden+Lake+Park+San+Jose" },
  { id:"hf-sj-f5", city:"San Jose", source:"google", name:"Alum Rock Park San Jose", desc:"Free historic park with creek trails and picnic areas for families", address:"16240 Alum Rock Ave, San Jose, CA 95127", phone:"(408) 259-5477", website:null, image:"/trail.jpg", isFree:true, price:"$0 FREE", stars:4, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Alum+Rock+Park+San+Jose" },
  ...
  { id:"hf-sa-f1", city:"Saratoga", source:"google", name:"Saratoga Creek Trail Free Walk", desc:"Free shaded creek trail walk for families and strollers", address:"Saratoga, CA 95070", phone:null, website:null, image:"/trail.jpg", isFree:true, price:"$0 FREE", stars:4, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2","3"], a11y:["🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Saratoga+Creek+Trail" },
  { id:"hf-sa-f2", city:"Saratoga", source:"google", name:"Saratoga Library Summer Reading", desc:"Free summer reading program with prizes for kids at Saratoga Library", address:"13650 Saratoga Ave, Saratoga, CA 95070", phone:"(408) 867-6126", website:"https://www.sccld.org", image:"/library.jpg", isFree:true, price:"$0 FREE", stars:5, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2"], a11y:["♿ Wheelchair","🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Saratoga+Library" },
  { id:"hf-sa-f3", city:"Saratoga", source:"google", name:"Wildwood Park Saratoga", desc:"Free neighborhood park with playground and open green space", address:"20764 Fourth St, Saratoga, CA 95070", phone:null, website:null, image:"/park.jpg", isFree:true, price:"$0 FREE", stars:4, startDate:"2026-06-01", endDate:"2026-08-31", ages:["0","1","2"], a11y:["🍼 Stroller OK"], mapsUrl:"https://www.google.com/maps/search/Wildwood+Park+Saratoga" },
...
export default async function handler(req, res) {
 ...
 // Add hardcoded first — resolve real venue photos
  for (const a of hardcodedFiltered) {
    const key = a.name.toLowerCase().slice(0, 30);
    if (!seen.has(key)) {
      seen.add(key);
      ...
      // Resolve real venue photo: Places API → Maps Static → local icon
      const placesPhoto = await getPlacePhoto(a.name, a.address || "", process.env.GOOGLE_PLACES_API_KEY);
      if (placesPhoto) {
        a.image = placesPhoto;
      } else if (process.env.GOOGLE_MAPS_API_KEY && a.address && a.address.length > 10) {
